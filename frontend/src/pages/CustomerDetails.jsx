...
import {updateCustomer } from '../redux/thunk/UserReducers'
...
import { getCustomerDetails } from '../redux/thunk/UserReducers'
function CustomerDetails() {

  const dispatch = useDispatch();
  const datas = useSelector((state) => state?.users?.data?.data)
            ...
            <div className="grid grid-cols-12 gap-10">
               ...
               
                {
                    ...
                    <img
                        ...
                        src={`${liveUrl}/${datas.profilePicture}`}
                        style={{width:1700,height:100}}
